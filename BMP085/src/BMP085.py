...
class BMP085():
   ...
   def _load_calibration(self):
     self.cal_AC1 = self._convert_to_signed(self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_AC1, 2)))
     self.cal_AC2 = self._convert_to_signed(self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_AC2, 2)))
     self.cal_AC3 = self._convert_to_signed(self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_AC3, 2)))  
     self.cal_AC4 = self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_AC4, 2)) # Not signed  
     self.cal_AC5 = self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_AC5, 2)) # Not signed  
     self.cal_AC6 = self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_AC6, 2)) # Not signed 
     self.cal_B1  = self._convert_to_signed(self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_B1, 2)))   
     self.cal_B2  = self._convert_to_signed(self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_B2, 2)))   
     self.cal_MB  = self._convert_to_signed(self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_MB, 2)))   
     self.cal_MC  = self._convert_to_signed(self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_MC, 2)))    
     self.cal_MD  = self._convert_to_signed(self._format_data(self.pi.i2c_read_i2c_block_data(self.bus_handler, self.BMP085_CAL_MD, 2)))     
   ...
   ''' Return one 16 bits when we rean i2c block data '''
   def _format_data(self, tulpe):
     return ((tulpe[1][0] << 8) + tulpe[1][1])
     
   def _convert_to_signed(self, x):
     if x >= (2**16)/2:
        x -= 2**16
     return x
